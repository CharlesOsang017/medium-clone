...
const EditProfile = ({ editModal, setEditModal, getUserData }) => {
  ...
  return (
    <Modal modal={editModal} setModal={setEditModal}>
      <div className='center bg-white mx-auto shadows w-[95%] md:w-[45rem] my-[1rem] z-20 mb-[3rem] p-[2rem]'>
        {/* head */}
          ...
          <div className='flex gap-[2rem]'>
            <div className='w-[5rem]'>
              <img
                ...
                src={imgUrl ? imgUrl : form.userImg ? form.userImg : "/profile.webp"}
                alt='profile-img'
              />
              <input
                onChange={(e) => {
            ...
            <div>
              ...
              <p className='sm:w-[20rem] w-full text-gray-500 text-sm pt-2'>
        ...
        {/* Profile edit form */}
        <section className='text-sm pt-[1rem]'>
        ...
        <div className='flex items-center justify-end gap-4 pt-[2rem]'>
          <button onClick={()=>setEditModal(false)} className='border border-green-600 py-2 px-5 rounded-full text-green-600'>
            Cancel
          </button>
          <button
            onClick={saveForm}
            className='border border-green-600 py-2 px-5 rounded-full bg-green-800 text-white'
          >
            Save
          </button>
        </div>
